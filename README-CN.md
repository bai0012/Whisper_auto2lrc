...
下载ffmpeg，并将包含ffmpeg.exe的文件夹添加到系统变量中，如[BtbN/FFmpeg-Builds](https://github.com/BtbN/FFmpeg-Builds/releases)。
...
本程序在GPT 4指导下完成，特别感谢[chshkhr](https://github.com/chshkhr)的贡献。
